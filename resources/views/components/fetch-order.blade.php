                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y">
                            ...
                            <button type="submit" form="form1" class="submitButton bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded m-2">
...
<script>
    ...
    const ids = document.querySelector(".checkboxClass");
    const addIds = document.querySelector(".addIds");
    const clickButton = document.querySelector(".clickButton");

    const submitButton = document.querySelector(".submitButton"),
        form = submitButton.form;
    clickButton.addEventListener("click", function() {
        addIds.value = ids.value;
        form.submit();
    })
</script>
