<div class="flex mx-3 justify-center mt-6 sm:px-6 lg:px-8">
    <div>
        ...
        <div>
            <form class="mt-8 space-y-6" action="{{ route('region.store') }}" method="POST">
                @csrf
                <div class="md:grid md:grid-cols-2 gap-6 mt-4">
                    <div class="mt-5 md:mt-2">
                        <label for="">Region Name <span class="text-red-500">*</span></label>
                    ...
                    <div class="mt-5 md:mt-2">
                        <label for="">Select Zone <span class="text-red-500">*</span></label>
                        <select name="zone_id" id="zone_id" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" required>
