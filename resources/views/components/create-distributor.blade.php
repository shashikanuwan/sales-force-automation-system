<div class="flex mx-3 justify-center mt-6 sm:px-6 lg:px-8">
    <div>
        ...
        <div>
            <form action="{{ route('distributor.store') }}" method="POST" class="mt-8 space-y-6">
                @csrf
                <div class="md:grid md:grid-cols-3 gap-6 mt-4">
                    ...
                    <div class="mt-5 md:mt-2">
                        ...
                        <input id="user_name" name="user_name" type="text" value="{{old('user_name')}}" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                    </div>

                    <div class="mt-5 md:mt-2">
                        <label for="">NIC <span class="text-red-500">*</span></label>
                        <input id="nic" name="nic" type="text" value="{{old('nic')}}" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                    </div>
